...
c----------------------------------------------------------------------------c
      ...
      open(unit=16,file='rilm.dat',status='unknown')
      ...
      open(unit=20,file='rcor.dat',status='unknown')
      open(unit=21,file='rcor2.dat',status='unknown')
      open(unit=22,file='rcor3.dat',status='unknown') 
